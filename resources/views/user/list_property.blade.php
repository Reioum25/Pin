    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.subscribe.post') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <!--  PROPERTY CATEGORY -->
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control" name="s">
                                        ...
                                        <option value="{{ $barangay->id }}"
                                            {{ (old('s') == $barangay->id) ? "selected='selected'" : "" }}>{{
                                        ...
                                        <option value="{{ $barangay->id }}"
                                            {{ (old('s') == $barangay->id) ? "selected='selected'" : "" }}>{{ $barangay->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 col-sm-12">
                        ...
                        <div class="form-group font-weight-bold">
                            ...
                            <div class="form-inline">
                                ...
                                {{Form::select('type', [ 'monthly' => 'Monthly', 'annual' => 'Annual'], null, ['class' => 'form-control col-md-4']) }}
                                {{Form::select('status', ['Available' => 'Available','Unavailable' => 'Unavailable'], null, ['class' => 'form-control col-md-4','placeholder' => 'Status', 'required']) }}
                            </div>
                        </div>
                        <div class="form-group font-weight-bold">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg btn-block" id="subscribe-to-post">Post listing</button>
                    </form>
                </div>
            </div>
        </div>
...
<!-- Modal -->
<div class="modal fade" id="subscribeNotice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Epwesto</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Listing of your property in Epwesto will let us help you find your best deals.
            </div>
            <div class="modal-footer">
                <a class="btn btn-secondary text-white" href="{{ url()->previous() }}">Back</a>
...
<script>
    ...
    $("#subscribe-to-post").click(function () {
        $("#subscribeToContinue").modal('show')
    });
</script>
<script>
    $('#subscribeNotice').modal('show')
</script>
